...
public class MissionTypeController {
    ...
    @PostMapping
    public String createMissionType(@ModelAttribute MissionType missionType, RedirectAttributes redirectAttributes) {
    ...
    public String updateMissionType(@PathVariable(name = "id") Long id, @ModelAttribute MissionType missionType, RedirectAttributes redirectAttributes) {
        missionTypeService.save(missionType);
