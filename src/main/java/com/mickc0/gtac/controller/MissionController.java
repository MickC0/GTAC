...
public class MissionController {
    ...
    @PostMapping
    public String createMission(@Valid @ModelAttribute(name = "mission") MissionDTO missionDTO,
    ...
    public String updateMission(@PathVariable(name = "id") UUID uuid,@Valid @ModelAttribute(name = "mission") MissionDTO missionDTO,
